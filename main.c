...
int main()
{
    ...
    if(a1==1)
    {
        ...
        if(a2==1)
        {
            printf("You have chose a Computer category\n\n");
        ...
        {
            printf("You can chosen Electronics category\n\n");
            ...
            {
                printf("You have chosen The art of electronics books\n\n");
                char book_namee[50];
            ...
            else if(a2==3)
            {
                ...
                {
                    printf("You have chosen Mechanical Engineering: Conventional and Objective Type book\n\n");
        ...
        else if(a1==3)
        {
            ...
            printf("Press the code:523 for Practical Electronics for Investors\n");
